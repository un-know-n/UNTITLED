...
{//Constructor
    Bonus_Rect.left = X;//x * Common::Block_Width * Common::Extent + Common::Level_X_Offset    I var
    Bonus_Rect.top = Y;//(Common::Level_Y_Offset + Y * Common::Cell_Height) * Common::Extent    II var
