...
public:
    ...
    void Move_Ball(CsEngine *engine);
...
public:
    ...
    static const int Max_Y_Pos = (200 - CBall::Ball_Size);
    ...
    int On_Timer();
    void Check_Ball_Colision(int &next_y_pos);
...
private:
    ...
    HPEN Green_Pen, Blue_Pen, Red_Pen, Yellow_Pen, Ellipse_Platform_Pen, 
        Rectangle_Platform_Pen, Arc_Pen, Border_Main_Pen, Border_White_Pen;
    HBRUSH Green_Brush, Blue_Brush, Red_Brush, Yellow_Brush, Ellipse_Platform_Brush, 
        Rectangle_Platform_Brush, Border_Main_Brush, Border_White_Brush;
